...
-- 12: KOGA
	...
	-- Pallet to Cinnabar
	--TODO: Combine Rare Candy + Carbos into single menu open to save ~30 frames
	...
	-- B1
	--TODO: Add menu cancel optimization after Rare Candy use to save menu close frames
