...
ANALYTICS_DRIVEN_RESETS = config.ANALYTICS_DRIVEN_RESETS or false
VIABILITY_RESET_THRESHOLD = config.VIABILITY_RESET_THRESHOLD  -- nil = disabled
CRIT_SURVIVAL_THRESHOLD = config.CRIT_SURVIVAL_THRESHOLD or 0.15
